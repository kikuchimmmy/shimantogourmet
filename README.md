...
- **最新デプロイ**: https://40d958e8.shimanto-restaurant-guide.pages.dev
...
- ✅ Google Maps地図表示（ズームレベル16、APIキー設定済み）
- ✅ レスポンシブデザイン（スマホ・タブレット対応）
- ✅ Google Drive画像プロキシ（CORS回避、写真表示対応）
- ✅ ジオコーディングAPI（並列処理・高速化）
- ✅ お店・スポットの写真表示（Google Drive連携）
